...
class SettingsDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        self.p1_upstream_cb = QCheckBox("启用上游代理")
        self.p1_upstream_cb.toggled.connect(lambda c: self.p1_upstream.setEnabled(c))
        p1_form.addRow(self.p1_upstream_cb)
        ...
        self.p2_upstream_cb = QCheckBox("启用上游代理")
        self.p2_upstream_cb.toggled.connect(lambda c: self.p2_upstream.setEnabled(c))
        p2_form.addRow(self.p2_upstream_cb)
